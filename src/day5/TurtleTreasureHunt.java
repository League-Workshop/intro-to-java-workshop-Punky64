...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		// 			make a pop-up tell the Tortoise where to go next
         if(tortoiseLocationX ==320&& tortoiseLocationY == 240){ JOptionPane.showMessageDialog(null," The wounded dead");
        	 
         }
        
         System.out.println(tortoiseLocationX +" "+ tortoiseLocationY);
         if(tortoiseLocationX ==140&& tortoiseLocationY == 45){ JOptionPane.showMessageDialog(null," it warns all");
       
    	 
         }
         if(tortoiseLocationX ==585&& tortoiseLocationY == 210){ JOptionPane.showMessageDialog(null,"You got gold, leave ");}
	}
